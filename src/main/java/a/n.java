...
public class n {
   ...
   @Compile
   private void a() {
      List var1 = Mytheria.getInstance().getFriendManager().listFriends();
      if (var1.isEmpty()) {
         eg.info(Text.of(av.translate("commands.friends.empty")));
      } else {
         eg.info(Text.of(av.translate("commands.friends.list")));

         for (int var2 = 0; var2 < var1.size(); var2++) {
            eg.info(Text.of("[" + (var2 + 1) + "] " + (String)var1.get(var2)));
         }
      }
   }
}
