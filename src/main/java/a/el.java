...
public final class el {
   public static String fetchJson(String usd) throws IOException {
      ...
      try (InputStream var4 = var2.getInputStream()) {
         return new String(var4.readAllBytes(), StandardCharsets.UTF_8);
      }
   }

   public static String extractImageUrl(String json) {
      Pattern var1 = Pattern.compile("\"url\"\\s*:\\s*\"([^\"]+)\"");
      Matcher var2 = var1.matcher(json);
      return var2.find() ? var2.group(1).replace("\\/", "/") : null;
   }
   ...
   public static NativeImage bufferedImageToNativeImage(BufferedImage bufferedImage, boolean avatar) {
      ...
      for (int var5 = 0; var5 < var3; var5++) {
         for (int var6 = 0; var6 < var2; var6++) {
            int var7 = bufferedImage.getRGB(var6, var5);
            var4.setColorArgb(var6, var5, var7);
         }
      }
