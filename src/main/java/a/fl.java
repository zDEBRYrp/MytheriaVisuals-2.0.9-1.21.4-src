...
public final class fl implements IMinecraft, IWindow {
   ...
   public static void prepareMatrices(MatrixStack matrices) {
      ...
      Vec3d var3 = Vec3d.ZERO.subtract(var2);
      matrices.translate(var3.getX(), var3.getY(), var3.getZ());
   }
   ...
   public static void prepareMatrices(MatrixStack matrices, Vec3d pos) {
      ...
      Vec3d var4 = pos.subtract(var3);
      matrices.translate(var4.getX(), var4.getY(), var4.getZ());
   }
   ...
   public static void buildBuffer(BufferBuilder builder) {
      BuiltBuffer var1 = builder.endNullable();
      if (var1 != null) {
