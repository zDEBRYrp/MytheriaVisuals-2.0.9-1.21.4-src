...
public class cq implements IMinecraft {
   public static final Comparator<Entity> DISTANCE = Comparator.comparingDouble(entity -> entity.distanceTo(mc.player));
   public static final Comparator<Entity> HEALTH = Comparator.comparingDouble(entity -> entity instanceof LivingEntity var1 ? var1.getHealth() : 0.0);
   public static final Comparator<Entity> FOV = Comparator.comparingDouble(entity -> {
      ...
      Vec3d var2 = entity.getPos();
      Vec3d var3 = mc.player.getRotationVec(1.0F);
      Vec3d var4 = var2.subtract(var1).normalize();
      double var5 = var3.dotProduct(var4);
      return Math.acos(MathHelper.clamp(var5, -1.0, 1.0)) * (180.0 / Math.PI);
   });
   public static final Comparator<Entity> BAD_ARMOR = Comparator.comparingDouble(entity -> {
      if (entity instanceof PlayerEntity var1) {
         double var2 = 0.0;

         for (ItemStack var5 : var1.getAllArmorItems()) {
            if (var5 != null && !var5.isEmpty()) {
               var2 += var5.getItem().getDefaultStack().getCount();
            }
         }
