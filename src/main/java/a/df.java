...
public abstract class df extends cn.a implements IScaledResolution {
   protected de size = new de(48.0F, 15.0F);
   protected final dZ animation = new dZ(500L, Easing.BAKEK_SIZE);

   public df(cn parent, String name) {
