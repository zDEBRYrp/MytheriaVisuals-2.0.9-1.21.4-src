...
@ModuleInfo(name = "FastExp", category = ax.PLAYER, desc = "modules.descriptions.fast_exp")
public class bj extends aJ {
   private final SliderSetting a = new SliderSetting(this, "modules.settings.fast_exp.delay")
      .min(1.0F)
      .max(180.0F)
      .step(1.0F)
      .currentValue(50.0F)
