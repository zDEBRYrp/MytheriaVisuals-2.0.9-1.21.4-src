...
public class dV extends CustomComponent {
   private final dW a;
   ...
   public dV(dW toggle, float x, float y, float width) {
      this.a = toggle;
      this.x = x;
      this.y = y;
      this.width = width;
      ...
      for (Setting var6 : toggle.getModule().getSettings()) {
   ...
   public void renderComponent(UIContext context) {
      ...
      context.drawBlurredRect(var5, var6, var7, var8, 11.25F, 5.0F, BorderRadius.all(11.0F), ec.WHITE);
      context.drawRoundedRect(var5, var6, var7, var8, BorderRadius.all(11.0F), new eb(15.0F, 15.0F, 20.0F).withAlpha(255.0F * var2));
      context.drawRoundedRect(
         ...
         new VerticalGradient(new eb(60.0F, 30.0F, 120.0F).withAlpha(40.0F * var2), new eb(40.0F, 20.0F, 80.0F).withAlpha(60.0F * var2))
      );
      if (this.d && var3) {
         context.drawRoundedRect(
            var5 + var7 - 25.0F,
         ...
         context.drawFadeoutText(
            ...
            av.translate(this.a.getModule().getDescription()),
            var5 + 7.0F,
      ...
      if (this.d) {
         context.drawText(
            ...
            av.translate(this.a.getModule().getName()),
            var5 + 7.0F + 2.0F * var2,
            var6 + 8.0F + 2.0F * var2,
            ec.getTextColor()
         );
      } else {
         context.drawText(Fonts.MEDIUM.getFont(9.0F), av.translate(this.a.getModule().getName()), var5 + 9.0F, var6 + 10.0F, ec.getTextColor());
      }
      ...
      this.l
         .update(this.a.getModule().isEnabled() ? var12 : Mytheria.getInstance().getThemeManager().getCurrentTheme().getAdditionalColor().mix(eb.BLACK, 0.3F));
   ...
   public void onMouseClicked(double mouseX, double mouseY, MouseButton button) {
      if (er.isHovered(this.x + this.width - 17.0F, this.y + 9.0F, 8.0, 8.0, mouseX, mouseY)) {
         this.d = false;
      } else if (er.isHovered(this.x, this.y, this.width, 24.0, mouseX, mouseY)) {
         this.h = true;
         this.f = (float)(mouseX - this.x);
         this.g = (float)(mouseY - this.y);
      } else if (er.isHovered(this.x, this.y + 24.0F - this.e.getValue(), this.width, 18.0, mouseX, mouseY) && button == MouseButton.LEFT) {
         this.a.getModule().toggle();
      } else {
         for (dz var7 : this.b) {
            if (var7.getOpacity() != 0.0F && var7.isHovered(mouseX, mouseY)) {
