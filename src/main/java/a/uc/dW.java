...
public class dW {
   ...
   public void render(UIContext context, float alpha) {
      ...
      this.b.update(this.a.isEnabled());
      ...
      context.drawText(
         Fonts.MEDIUM.getFont(8.0F), av.translate(this.a.getName()), this.d + 10.0F, this.e + this.g / 2.0F - 3.5F, ec.WHITE.withAlpha(255.0F * alpha)
      );
      float var6 = 28.0F;
      float var7 = 14.0F;
      float var8 = this.d + this.f - var6 - 10.0F;
      float var9 = this.e + this.g / 2.0F - var7 / 2.0F;
      if (this.a.isEnabled()) {
         context.drawRoundedRect(
            var8,
            var9,
            var6,
            var7,
            BorderRadius.all(var7 / 2.0F),
            new VerticalGradient(new eb(140.0F, 80.0F, 240.0F).withAlpha(255.0F * alpha), new eb(100.0F, 50.0F, 200.0F).withAlpha(255.0F * alpha))
         );
      } else {
         context.drawRoundedRect(var8, var9, var6, var7, BorderRadius.all(var7 / 2.0F), new eb(50.0F, 50.0F, 60.0F).withAlpha(255.0F * alpha));
      }

      float var10 = 10.0F;
      float var11 = 2.0F;
      float var12 = var8 + var11 + (var6 - var10 - var11 * 2.0F) * this.b.getValue();
      float var13 = var9 + (var7 - var10) / 2.0F;
      context.drawRoundedRect(var12, var13, var10, var10, BorderRadius.all(var10 / 2.0F), ec.WHITE.withAlpha(255.0F * alpha));
   }

   public void onMouseClicked(double mouseX, double mouseY, MouseButton button, dR screen) {
      if (button == MouseButton.LEFT) {
         this.a.toggle();
      } else if (button == MouseButton.RIGHT && this.a.getSettings().size() > 0) {
         dV var7 = new dV(this, screen.getMenuWindow().getX() + screen.getMenuWindow().getWidth() + 10.0F, screen.getMenuWindow().getY(), 200.0F);
         screen.getWindows().add(var7);
      }
   }
