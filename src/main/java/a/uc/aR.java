...
@ModuleInfo(name = "Auto Accept", category = ax.PLAYER, desc = "Автоматически принимает телепортацию")
public class aR extends aJ {
   private final ck a = new ck(this, "Принимать");
   private final ck.a b = new ck.a(this.a, "Всех");
   private final ck.a c = new ck.a(this.a, "Только друзей");
   private final EventListener<S> d = event -> {
      if (event.getPacket() instanceof GameMessageS2CPacket var2
         && mc.player != null
         && var2.content().getString().contains("телепортироваться")
         && !ep.hasCT
         && this.a(var2.content().getString())) {
   ...
   private boolean a(String message) {
      ...
      if (this.a.is(this.c)) {
         ...
         if (message.contains("телепортироваться")) {
            ...
            return var2.length >= 2 && Mytheria.getInstance().getFriendManager().isFriend(var2[2]);
         }
      }
