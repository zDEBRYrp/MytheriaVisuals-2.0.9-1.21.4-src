...
public abstract class eQ {
   ...
   public eQ(String symbol, int numberOfOperands, boolean leftAssociative, int precedence) {
      this.a = numberOfOperands;
      this.b = leftAssociative;
      this.c = symbol;
      this.d = precedence;
   }

   public static boolean isAllowedOperatorChar(char ch) {
      for (char var4 : ALLOWED_OPERATOR_CHARS) {
         if (ch == var4) {
            return true;
         }
      }
