...
public class dD extends dz<ci> {
   public dD(ci setting, CustomComponent parent) {
   ...
   public void renderComponent(UIContext context) {
      ...
      context.drawRoundedRect(
         ...
         ec.getBackgroundColor().withAlpha(255.0F * (0.3F + 0.2F * this.hoverAnimation.getValue()))
      );
      context.drawCenteredText(
         var2,
         av.translate(this.setting.getName()),
         this.x + this.width / 2.0F,
         this.y + er.getMiddleOfBox(var2.height(), this.height) - 0.5F,
