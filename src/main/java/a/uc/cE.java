...
public class cE extends cD {
   ...
   public void renderComponent(UIContext context) {
      ...
      this.e.update(this.isHovered(context.getMouseX(), context.getMouseY()));
      if (this.isHovered(context.getMouseX(), context.getMouseY())) {
         eo.set(en.HAND);
      }

      eb var5 = !this.b.equals(av.translate("remove")) ? ec.getTextColor() : eb.RED.mix(eb.WHITE, 0.3F);
      context.drawFadeoutText(
         var2,
         this.b,
         this.x + var3,
         this.y + er.getMiddleOfBox(var4, this.height),
         var5.withAlpha(RenderSystem.getShaderColor()[3] * 255.0F * (0.75F + 0.25F * this.e.getValue())),
         0.8F,
         1.0F,
         this.width - 24.0F
      );
   ...
   @Generated
   public cE(cC popup, String text, String icon, PopupAction action) {
      this.a = popup;
      this.b = text;
      this.c = icon;
      this.d = action;
