...
public abstract class eO {
   ...
   public eO(String name, int numArguments) {
      if (numArguments < 0) {
   ...
   public static char[] getAllowedFunctionCharacters() {
      char[] var0 = new char[53];
      int var1 = 0;

      for (int var2 = 65; var2 < 91; var2++) {
         var0[var1++] = (char)var2;
      }

      for (int var3 = 97; var3 < 123; var3++) {
         var0[var1++] = (char)var3;
      }
   ...
   public static boolean isValidFunctionName(String name) {
      ...
      for (int var2 = 0; var2 < var1; var2++) {
         ...
         if (!Character.isLetter(var3) && var3 != '_' && (!Character.isDigit(var3) || var2 <= 0)) {
            return false;
         }
      }
