...
public class dK extends dz<co> {
   private cK a;

   public dK(co setting, CustomComponent parent) {
   ...
   public void onInit() {
      ...
      this.a.paste(this.setting.getText());
      this.a.setPreview(av.translate("type_text"));
      super.onInit();
   }
   ...
   public void renderComponent(UIContext context) {
      ...
      float var6 = 13.0F;
      float var7 = 8.0F;
      Font var8 = Fonts.REGULAR.getFont(8.0F);
      float var9 = 10.0F;
      ...
      context.drawFadeoutText(
         ...
         this.x + var9,
         this.y + er.getMiddleOfBox(var8.height(), var11) - 0.5F,
         ec.getTextColor().withAlpha(255.0F * (0.75F + 0.25F * this.hoverAnimation.getValue())),
         0.7F,
         0.99F,
         var4 - var6 - 20.0F
      );
      context.drawRoundedRect(var2, var3, var4, var5, BorderRadius.all(4.0F), ec.getBackgroundColor().withAlpha(76.5F));
      this.a.set(var2, var3, var4, var5);
      this.a.setAlpha(1.0F);
      this.a.setTextColor(ec.getTextColor());
      this.a.render(context);
      this.setting.text(this.a.getBuiltText());
   }
