...
public class doItem extends cn.a {
   private String a = "?";
   private String b = "";
   ...
   public doItem(cn parent, String name, String suffix) {
      super(parent, name);
      this.select();
      this.c = " " + suffix;
   }

   public doItem(cn parent, String name) {
      super(parent, name);
      this.select();
      this.c = "";
   }
   ...
   @Generated
   public dZ successAnim() {
      return this.g;
   }

   @Generated
   public doItem copied(boolean copied) {
      this.d = copied;
      return this;
   }
}
